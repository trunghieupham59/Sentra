...
const en: Translations = {
  ...
  settings_local_ai_start_runtime: 'Start a local runtime, then refresh. Supports Ollama, LM Studio, and llama.cpp.',
  ...
  settings_local_ai_install_runtime_desc: 'Install a runtime once to download and run models such as DeepSeek, Qwen, Gemma, or Llama on this device.',
