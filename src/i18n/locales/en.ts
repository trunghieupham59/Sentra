...
const en: Translations = {
  ...
  settings_extension_install_step3: 'The Lotus icon appears in the Chrome toolbar',
  ...
  settings_bookmarklet_step2_desc: 'Lotus icon appears bottom-right · Translate to:',
