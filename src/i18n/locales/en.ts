...
const en: Translations = {
  ...
  settings_la_section_desc: 'Inject a floating Sentra icon directly into any browser — no extension required. Works in Chrome, Arc, Brave, Safari and more.',
  ...
  settings_la_bookmarklet_desc: 'Drag this link to your bookmarks bar. Click it on any page to inject the Sentra instantly.',
  ...
  settings_extension_section_desc: 'Connect the Sentra Chrome Extension to translate text directly in your browser. The extension uses your API keys configured above.',
  settings_extension_token_label: 'Connection Token',
  settings_extension_token_desc: 'Copy this token into the Sentra Extension options page. Keep it private.',
  ...
  settings_extension_install_hint: 'Install the Sentra Chrome Extension, then open its options page and paste this token.',
  ...
  settings_extension_install_step3: 'The Sentra icon appears in the Chrome toolbar',
  settings_extension_install_step4: 'Click icon → Options → paste the Connection Token below',
  settings_update_section: 'Updates',
  settings_update_section_desc: 'Keep Sentra up to date with the latest features and bug fixes.',
  ...
  settings_bookmarklet_step2_desc: 'Sentra icon appears bottom-right · Translate to:',
