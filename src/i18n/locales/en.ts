...
const en: Translations = {
  ...
  settings_la_section_desc: 'Inject a floating T.R.E Assistant icon directly into any browser — no extension required. Works in Chrome, Arc, Brave, Safari and more.',
  ...
  settings_la_bookmarklet_desc: 'Drag this link to your bookmarks bar. Click it on any page to inject the T.R.E Assistant instantly.',
  ...
  settings_extension_install_hint: 'Install the T.R.E Assistant Chrome Extension, then open its options page and paste this token.',
  ...
  settings_extension_install_step3: 'The T.R.E Assistant icon appears in the Chrome toolbar',
  settings_extension_install_step4: 'Click icon → Options → paste the Connection Token below',
  settings_update_section: 'Updates',
  settings_update_section_desc: 'Keep T.R.E Assistant up to date with the latest features and bug fixes.',
  ...
  settings_bookmarklet_step2_desc: 'T.R.E Assistant icon appears bottom-right · Translate to:',
