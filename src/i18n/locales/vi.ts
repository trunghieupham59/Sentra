...
const vi: Translations = {
  ...
  ai_chat_popup_placeholder: 'Hỏi bất cứ điều gì… (Enter để gửi)',
  ...
  settings_chat_hotkey_section_desc: 'Nhấn phím tắt trong bất kỳ ứng dụng nào để mở popup hỏi nhanh AI.',
  settings_chat_hotkey_enabled: 'Bật phím tắt',
  settings_chat_hotkey_enabled_desc: 'Kích hoạt phím tắt toàn cục để mở popup AI Chat',
