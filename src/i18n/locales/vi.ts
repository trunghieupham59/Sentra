...
const vi: Translations = {
  ...
  settings_la_section_desc: 'Inject icon T.R.E Assistant nổi trực tiếp vào trình duyệt — không cần cài extension. Hoạt động trên Chrome, Arc, Brave, Safari và nhiều trình duyệt khác.',
  ...
  settings_la_bookmarklet_desc: 'Kéo link này vào thanh bookmarks. Click vào bất kỳ trang nào để inject T.R.E Assistant ngay lập tức.',
  ...
  settings_extension_install_hint: 'Cài tiện ích T.R.E Assistant Chrome, mở trang Options và dán token này vào.',
  ...
  settings_extension_install_step3: 'Icon T.R.E Assistant xuất hiện trong thanh công cụ Chrome',
  settings_extension_install_step4: 'Click icon → Options → dán Token kết nối (bên dưới)',
  settings_update_section: 'Cập nhật',
  settings_update_section_desc: 'Giữ T.R.E Assistant luôn cập nhật với tính năng mới nhất và bản sửa lỗi.',
  ...
  settings_bookmarklet_step2_desc: 'Icon T.R.E Assistant xuất hiện góc dưới-phải · Dịch sang:',
  settings_bookmarklet_label: '🌐 T.R.E Translate',
