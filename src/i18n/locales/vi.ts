...
const vi: Translations = {
  ...
  settings_local_ai_start_runtime: 'Mở runtime local rồi tải lại. Hỗ trợ Ollama, LM Studio và llama.cpp.',
  ...
  settings_local_ai_install_runtime_desc: 'Cài runtime một lần để tải và chạy các model như DeepSeek, Qwen, Gemma hoặc Llama ngay trong máy.',
