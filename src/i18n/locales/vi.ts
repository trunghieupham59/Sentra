...
const vi: Translations = {
  ...
  settings_la_section_desc: 'Inject icon Sentra nổi trực tiếp vào trình duyệt — không cần cài extension. Hoạt động trên Chrome, Arc, Brave, Safari và nhiều trình duyệt khác.',
  ...
  settings_la_bookmarklet_desc: 'Kéo link này vào thanh bookmarks. Click vào bất kỳ trang nào để inject Sentra ngay lập tức.',
  ...
  settings_extension_section_desc: 'Kết nối tiện ích Sentra Chrome để dịch văn bản trực tiếp trên trình duyệt. Tiện ích sử dụng API key bạn đã cấu hình ở trên.',
  settings_extension_token_label: 'Token kết nối',
  settings_extension_token_desc: 'Sao chép token này vào trang Options của tiện ích Sentra. Giữ bí mật token.',
  ...
  settings_extension_install_hint: 'Cài tiện ích Sentra Chrome, mở trang Options và dán token này vào.',
  ...
  settings_extension_install_step3: 'Icon Sentra xuất hiện trong thanh công cụ Chrome',
  settings_extension_install_step4: 'Click icon → Options → dán Token kết nối (bên dưới)',
  settings_update_section: 'Cập nhật',
  settings_update_section_desc: 'Giữ Sentra luôn cập nhật với tính năng mới nhất và bản sửa lỗi.',
  ...
  settings_bookmarklet_step2_desc: 'Icon Sentra xuất hiện góc dưới-phải · Dịch sang:',
  settings_bookmarklet_label: '🌐 Sentra Translate',
