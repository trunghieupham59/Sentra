...
const ja: Translations = {
  ...
  ai_chat_popup_placeholder: '何でも聞いてください…（Enterで送信）',
  ...
  settings_chat_hotkey_section_desc: '任意のアプリでショートカットを押すと、AIクイック質問ポップアップが開きます。',
  settings_chat_hotkey_enabled: 'ホットキーを有効にする',
  settings_chat_hotkey_enabled_desc: 'AIチャットポップアップを開くグローバルショートカットを有効化',
