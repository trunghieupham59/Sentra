...
const ja: Translations = {
  ...
  settings_la_section_desc: 'T.R.E Assistantのフローティングアイコンを直接ブラウザに注入 — 拡張機能不要。Chrome、Arc、Brave、Safariなどで動作します。',
  ...
  settings_la_bookmarklet_desc: 'このリンクをブックマークバーにドラッグ。任意のページでクリックするとT.R.E Assistantを即座に注入できます。',
  ...
  settings_extension_install_hint: 'T.R.E Assistant Chrome拡張機能をインストールし、オプションページを開いてこのトークンを貼り付けてください。',
  ...
  settings_extension_install_step3: 'T.R.E Assistantアイコンがツールバーに表示されます',
  settings_extension_install_step4: 'アイコン → Options → 以下の接続トークンを貼り付ける',
  settings_update_section: 'アップデート',
  settings_update_section_desc: '最新の機能とバグ修正でT.R.E Assistantを最新の状態に保ちます。',
  ...
  settings_bookmarklet_step2_desc: 'T.R.E Assistantアイコンが右下に表示 · 翻訳先:',
