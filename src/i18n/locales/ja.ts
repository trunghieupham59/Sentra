...
const ja: Translations = {
  ...
  settings_local_ai_start_runtime: 'ローカルランタイムを起動して更新してください。Ollama、LM Studio、llama.cppに対応しています。',
  ...
  settings_local_ai_install_runtime_desc: 'ランタイムを一度インストールすると、DeepSeek、Qwen、Gemma、Llamaなどのモデルをこのデバイスでダウンロードして実行できます。',
