...
const ja: Translations = {
  ...
  settings_la_section_desc: 'Sentraのフローティングアイコンを直接ブラウザに注入 — 拡張機能不要。Chrome、Arc、Brave、Safariなどで動作します。',
  ...
  settings_la_bookmarklet_desc: 'このリンクをブックマークバーにドラッグ。任意のページでクリックするとSentraを即座に注入できます。',
  ...
  settings_extension_section_desc: 'Sentra Chrome拡張機能を接続してブラウザで直接テキストを翻訳します。上記で設定したAPIキーを使用します。',
  settings_extension_token_label: '接続トークン',
  settings_extension_token_desc: 'このトークンをSentra拡張機能のオプションページにコピーしてください。トークンは秘密にしてください。',
  settings_extension_token_copy: 'トークンをコピー',
  settings_extension_token_copied: 'コピーしました！',
  settings_extension_token_regenerate: '再生成',
  settings_extension_install_hint: 'Sentra Chrome拡張機能をインストールし、オプションページを開いてこのトークンを貼り付けてください。',
  ...
  settings_extension_install_step3: 'Sentraアイコンがツールバーに表示されます',
  settings_extension_install_step4: 'アイコン → Options → 以下の接続トークンを貼り付ける',
  settings_update_section: 'アップデート',
  settings_update_section_desc: '最新の機能とバグ修正でSentraを最新の状態に保ちます。',
  ...
  settings_bookmarklet_step2_desc: 'Sentraアイコンが右下に表示 · 翻訳先:',
