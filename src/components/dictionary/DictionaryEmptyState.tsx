  ...
  return (
    <div className="flex flex-1 flex-col items-center justify-center gap-5 px-6 py-10 text-center">
      <div className="relative">
        <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-white text-gray-500 shadow-sm shadow-gray-900/5 ring-1 ring-gray-200 dark:bg-neutral-900 dark:text-gray-300 dark:ring-neutral-800">
          <BookIcon className="h-7 w-7" />
        </div>
        <div className="absolute -right-1.5 -top-1.5 flex h-6 w-6 items-center justify-center rounded-full bg-white shadow-sm shadow-gray-900/10 ring-1 ring-gray-200 dark:bg-neutral-900 dark:ring-neutral-800">
