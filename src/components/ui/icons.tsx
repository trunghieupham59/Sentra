 ...
 * across the app. Import from here instead of duplicating inline SVG markup.
 *
 * All icons:
 *   - Accept a `className` prop for sizing / color overrides
 *   - Set `aria-hidden="true"` (decorative — labels come from parent buttons)
 *   - Use `currentColor` so Tailwind text-* utilities control the color
 */
...
/**
 * Spinning loading indicator. Apply `animate-spin` via `className` or include
 * it in the default class. Typically sized with `w-3.5 h-3.5` or `w-4 h-4`.
 */
